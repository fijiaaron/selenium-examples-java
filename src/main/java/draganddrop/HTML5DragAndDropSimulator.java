...
// see https://github.com/seleniumhq/selenium-google-code-issue-archive/issues/6315

// copied from https://storage.googleapis.com/google-code-attachments/selenium/issue-6315/comment-5/HTML5DragAndDropSimulator.txt

public class HTML5DragAndDropSimulator implements DragAndDrop
{
	 ...
	 * @param dragFromX The position to click relative to the top-left-corner of the
	 *                  client
	 * @param dragFromY The position to click relative to the top-left-corner of the
	 *                  client
	 * @param dragToX   The position to release relative to the top-left-corner of the
	 *                  client
	 * @param dragToY   The position to release relative to the top-left-corner of the
	 *                  client
	 */
	...
	public static void DragAndDrop(WebElement orig, WebElement dest, WebDriver driver)
	{
		HTML5DragAndDropSimulator.html5_DragAndDrop(driver, orig, dest, orig.getLocation().getX(), orig.getLocation().getY(), dest.getLocation().getX(), dest.getLocation().getY());
	}
	
	public void dragAndDrop(WebElement orig, WebElement dest, WebDriver driver)
	{
		HTML5DragAndDropSimulator.DragAndDrop(orig, dest, driver);
	}
